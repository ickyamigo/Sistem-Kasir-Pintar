...
public class Petugas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel7.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, 130, -1));
        jPanel7.add(idkasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 110, 220, 30));

        jLabel13.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel13.setText("Password");
        jPanel7.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 110, 130, -1));
        jPanel7.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 110, 220, 30));
        ...
        jPanel7.add(alamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 170, 220, 30));

        jLabel14.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel14.setText("No Hp");
        jPanel7.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 130, -1));
        jPanel7.add(nmkasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, 220, 30));

        jLabel5.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel5.setText("Nama Kasir");
        jPanel7.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 140, -1));

        jLabel10.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel10.setText("Gaji");
        jPanel7.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 140, -1));
        jPanel7.add(nohp, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 280, 220, 30));
        ...
        jPanel7.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 460, 780, 150));
        ...
        jPanel7.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 390, 120, 40));
        ...
        jPanel7.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 390, 120, 40));
        ...
        jPanel7.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 390, 120, 40));

        jLabel15.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel15.setText("Alamat");
        jPanel7.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 170, 130, -1));

        jabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
        jPanel7.add(jabatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 230, 220, 30));

        jLabel22.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel22.setText("Jabatan");
        jPanel7.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 230, 130, -1));

        jLabel23.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 29)); // NOI18N
        jLabel23.setText("Jabatan");
        jPanel7.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 230, 130, -1));
        jPanel7.add(gaji1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 230, 220, 30));
...
String Id_Petugas = idkasir.getText();
String Nama_Petugas = nmkasir.getText() ;
...
new Login().setVisible(true);         // TODO add your handling code here:
    ...
    String sql = "UPDATE petugas SET Nama_Petugas='" + nmkasir.getText() + "' ,Jabatan='" + jabatan.getSelectedItem()+ "' ,Gaji='" + gaji1.getText() + "' ,Alamat='"
            + alamat.getText() + "' ,No_Hp='" + nohp.getText() + "' ,Password='" + password.getText()+ "'WHERE Id_Petugas = '"+idkasir.getText()+"'";;
            java.sql.Connection conn = (Connection) SKP.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute(sql);
...
datatable();           // TODO add your handling code here:
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        String Idpetugas = tabel.getValueAt(baris, 0).toString();
        idkasir.setText(Idpetugas);

        String Nmpetugas = tabel.getValueAt(baris, 1).toString();
        nmkasir.setText(Nmpetugas);
        ...
        jabatan.setSelectedItem(Jabatan);        // TODO add your handling code here:
